...
export default function InfiniteScroll() {
    ...
    const infiniteFetchData = () => {
        ...
        fetch(`https://api.unsplash.com/search/photos?page=${pageIndex}&per_page=30&query=${searchState}&client_id=pLiM7PUy6ov_hFHzFgybzHXZa5ApV0UYSDIFkvyga-Q`).then((response) => {
